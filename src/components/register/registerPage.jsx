...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      <div className="w-[53%] h-[40rem] relative rounded-xl pr-[1.5rem] ml-[-5rem]">
        <Swiper
          autoplay={true}
          ref={swiperRef}
      ...
      <div className="flex-col justify-center px-[1rem] pt-[2rem]">
        ...
        <div className="flex-col gap-y-3">
          <div className="flex items-center gap-6 mt-[2rem]">
            <input
              placeholder="نام"
              className="border-transparent border-[2px] backdrop-blur-md focus:border-[#847EA0] transition-all duration-100 bg-[#3B364C] text-xl py-3 pr-3 rounded-lg outline-none  text-white"
            ></input>
            <input
              placeholder="نام خانوادگی"
              className="border-transparent border-[2px] focus:border-[#847EA0] transition-all duration-100  text-xl py-3 pr-3 bg-[#3B364C] rounded-lg outline-none  text-white"
            ></input>
          </div>
        ...
        <div className="flex justify-center items-center bg-gradient-to-r from-violet-600 to-indigo-600 mt-[3rem] rounded-md cursor-pointer w-[100%] py-3">
