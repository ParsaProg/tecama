...
export default function RatedTestExamPage(props) {
  ...
  const [questions, setQuestions] = useState([
    ...
    {
      id: 2,
      question: "خروجی کد پایین چیست؟",
      codeText: `import random
      for i in range(1, 10):
        print(i * "*")
      if v == 50:
        print(random.randint(0, 50))`,
      options: ["10", "5", "Syntax Error", "3.14"],
    ...
    },
    {
      id: 3,
      question: "پارسا کیه؟",
      options: ["String", "برادر یه دختر نخبه", "Boolean", "Array"],
      correctAnswer: "برادر یه دختر نخبه",
      canAns: true,
      codeBlock: false,
    },
    {
      ...
      options: ["String", "Number", "Boolean", "ListTile"],
      correctAnswer: "ListTile",
      canAns: true,
      codeBlock: false,
    },
    {
  ...
  return props.isLogin !== "notLoggined" ? (
    <motion.div
    ...
    <Navigate to="/exams/rated"></Navigate>
  );
}
